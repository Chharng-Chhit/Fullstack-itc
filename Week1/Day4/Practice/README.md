...
CSS Basic Styling — CSS Foundation

## TP Objective

Apply one external CSS file to the HTML project created in the previous sessions. Style the body, headings, links, forms, and tables; establish a project theme color; and improve page spacing.

## Starter Files

- `index.html` — styled product list and table
...
- Styled labels, inputs, selects, textarea, and buttons
- Visible use of margin, padding, and border
- Improved spacing and readable page layout
...
- [ ] Form labels and inputs are aligned and spaced
- [ ] Theme colors are consistent
- [ ] Student changes are saved
- [ ] Screenshots of all styled pages are included

## Challenge

Create a second theme by changing only the color values in `style.css`. Do not edit the HTML files.
